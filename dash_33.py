...
app = dash.Dash('dash_33', sharing=True, url_base_pathname='/dash_33', csrf_protect=False, server=server) 

app.config['suppress_callback_exceptions']=True

df = pd.read_csv('app_6/horror_films.csv') 
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        className='col',
                        children=[
                        html.Img(id='https://thumbs.dreamstime.com/z/american-businessman-flag-dollar-sign-21632712.jpg'), 
                        html.P(
                        'A Deplorable Snowflake Production:'
                        ),
                        html.A(
                            'Deplorable Snowflake',
                            href='https://deplorablesnowflake.org'
                        )                    
                    ]
                )], 
...
def update_graph_3(year_value):
    ...
    layout = go.Layout(
        ...
        title = 'Films by Jump, Gore & Scare (size of circle)', 
        margin={'l': 40, 'b': 40, 't': 10, 'r': 0},
        hovermode='closest',
        paper_bgcolor='#191a1a',
        plot_bgcolor='#191a1a',
